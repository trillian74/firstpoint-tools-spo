                ...
                component = new fabric['Spinner'](elements[i]);
						...
						<asp:Content ContentPlaceHolderId="PlaceHolderMain" runat="server">
							...
							<div id="ToolHeader" class="ms-font-m">
								...
								<div id="SelectedProjectContainer" class="ms-Grid-row">
									<h2 class="ms-font-xl ms-fontWeight-semibold">
										<span class="ms-font-su">Distribuere oppgaver</span>
									</h2>
								</div>

								<div class="ms-font-m" id="ToolStatusLabel">
									verktøystatus: Beta test
								</div>
								<div class="ms-Grid ms-bgColor-neutralLighter">

									<div class="ms-Grid-row">
										<div class="ms-Grid-col ms-u-sm4 ms-bgColor-neutralLighter ms-fontColor-black">
											<div id="InstallationPicker" class="ms-font-m">
												<div class="ms-font-xxl">Velg installasjoner</div>
										...
										<div class="ms-Grid-col ms-u-sm4  ms-bgColor-neutralLighter ms-fontColor-black">
											<div class="ms-font-xxl">Oppgavedetaljer</div>
												...
												<div id="distribute-tasks" class="ms-Grid-row">
													<div class="ms-Grid-col ms-u-sm12">
														...
														<div class="ms-DatePicker">
															<div class="ms-TextField">
																...
																<input id="task-start-date" name="task-start-date" class="ms-TextField-field" type="text" placeholder="Velg dato" value=""
																	required>
															</div>
													...
													<div class="ms-Grid-col ms-u-sm12">
														...
														<div class="ms-DatePicker">
															<div class="ms-TextField">
																...
																<input id="task-due-date" name="task-due-date" class="ms-TextField-field" type="text" placeholder="Velg dato" value=""  label="Påkrevd felt" required>
															</div>
															<div class="ms-DatePicker-monthComponents">
																<span class="ms-DatePicker-nextMonth js-nextMonth"><i class="ms-Icon ms-Icon--chevronRight"></i></span>
																<span class="ms-DatePicker-prevMonth js-prevMonth"><i class="ms-Icon ms-Icon--chevronLeft"></i></span>
													...
													<div class="ms-Grid-col ms-u-sm12">
														<div class="ms-TextField  is-required">
															<input class="ms-TextField-field text-box single-line is-required" id="task-title" name="task-title" type="text"  label="Påkrevd felt" required />
											...
											<div class="ms-Grid">
												<div class="ms-Grid-row">
													<div class="ms-Grid-col ms-u-lg12">
														<div class="ms-font-xxl">Installasjoner</div>
														<div class="ms-Table">
