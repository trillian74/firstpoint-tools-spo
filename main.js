...
/***/ function(module, exports) {
	...
	var AddInstallations = function AddInstallations() {
	    $.ajax({
	...
	BBTOOLSMAN.prototype = {
	    ...
	    removePeoplePickerValue: function removePeoplePickerValue(element) {
	        element.hide();
	    ...
	    setPeoplePickerValue: function setPeoplePickerValue(picker, displayName, userPrincipalName) {
	        // Set displayName
	    ...
	    selectUser: function selectUser(element) {
	    ...
	    searchForUsers: function searchForUsers(element) {
	    ...
	    logArrayElements: function logArrayElements(element) {
	        console.log('locations[' + element.Title + '] = ' + element);
	    },
	    setSelectedSiteInfo: function setSelectedSiteInfo(params) {
	        ...
	        return new Promise(function (resolve, reject) {
	            ...
	            dao.web.subsites().then(function (sites) {
	                ...
	                that.locations.forEach(function (element) {
	                    ...
	                    that.SelectedSites.push(sites[index]);
	                }, that);
	                resolve(that);
	    ...
	    setSelectedSites: function setSelectedSites(arr) {
	        this.SelectedSites = arr;
	    },
	    setLocations: function setLocations(selectedLocations) {
	        this.locations = selectedLocations;
	    },
	    findLocationById: function findLocationById(id) {},
	    addLocation: function addLocation(item) {
	        ...
	        this.locations.map(function (obj) {
	    ...
	    createTasks: function createTasks(item) {
	        var dao = new SPScript.RestDao();
	    ...
	    GetUserId: function GetUserId(accountName) {
	        return new Promise(function (resolve, reject) {
	            /// get the site url
	    ...
	    assignUserTask: function assignUserTask() {
	        ...
	        if (filteredInputs.length !== 0) {
	            ...
	            var user = this.GetUserId($(".user-principal").attr("value")).then(function (id) {
	    ...
	    removeInstallationRow: function removeInstallationRow(title) {
	        $(title).remove();
	    },
	    addInstallationRow: function addInstallationRow(item) {
	        return "<div class=\"ms-Table-row " + item.Id + "\"><span class=\"ms-Table-cell ms-font-xl\">" + item.Title + "</span><span class=\"ms-Table-cell ms-font-xl\">" + (item.AssignedTo === null ? "<button class=\"ms-Button ms-Button--command\" onclick=\"ShowAddUser('" + item.Id + "');\"><span class=\"ms-Button-icon\"><i class=\"ms-Icon ms-Icon--plus\"></i></sp" + "an> <span class=\"ms-Button-label\">Tilordnet til</span></button>" : item.AssignedTo) + "</span><span class=\"ms-Table-cell ms-font-xl\">" + item.Title + "</span></div>";
	    },
	    reactOnButton: function reactOnButton(button) {
	        switch (button) {
	            case "Distribute tasks":
	                this.setSelectedSiteInfo(this).then(function (result) {
	                ...
	                $('#example').on('click', 'tbody td', function () {
	                    var data = dataTableExample.cell(this).render('display');
	                    ...
	                    if (column_num === 3) {
	                        ...
	                        if ($(this).children().length === 0) {
	                            ...
	                            $(input).pickSPUser({
	                                ...
	                                onPickUser: function onPickUser(u) {
